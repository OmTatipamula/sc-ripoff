...
DWORD MapStartType(const std::string &startType) {
    if (startType == "boot") return SERVICE_BOOT_START;
    if (startType == "system") return SERVICE_SYSTEM_START;
    if (startType == "auto") return SERVICE_AUTO_START;
    if (startType == "demand") return SERVICE_DEMAND_START;
    if (startType == "disabled") return SERVICE_DISABLED;
    if (startType == "delayed-auto") return SERVICE_AUTO_START;
...
DWORD MapErrorControl(const std::string &errorControl) {
    if (errorControl == "normal") return SERVICE_ERROR_NORMAL;
    if (errorControl == "severe") return SERVICE_ERROR_SEVERE;
    if (errorControl == "critical") return SERVICE_ERROR_CRITICAL;
    if (errorControl == "ignore") return SERVICE_ERROR_IGNORE;
